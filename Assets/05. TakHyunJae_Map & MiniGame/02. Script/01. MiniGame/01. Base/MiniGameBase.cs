...
public abstract class MiniGameBase : MonoBehaviour
{
    ...
    {
        if (isGameActive && GlitchEffectManager.Instance != null)
        {
            GlitchEffectManager.Instance.UpdateVignettePulse(timeRemaining);
        }
    }
    ...
    protected void TriggerSuccess()
    {
        ...
        if (GlitchEffectManager.Instance != null)
            GlitchEffectManager.Instance.UpdateVignettePulse(0f);
    ...
    protected void TriggerFailure()
    {
        ...
        if (GlitchEffectManager.Instance != null)
            GlitchEffectManager.Instance.TriggerGlitch(0.4f); // 화면 전체 렌즈 글리치 연출
