    ...
    public class MenuItem : MonoBehaviour //MonoBehaviour is required for destroy immediate/instantiate etc.
    {
        ...
        private static void CheckForRayCaster()
        {
            ...
            if (xRToolkitGlobalInputControllerForModularTextAsset != null)
            {
                ...
                var vrController = FindAnyObjectByType(Type.GetType("TinyGiantStudio.Text.XRToolkitGlobalInputControllerForModularTextAsset"));
...
#if UNITY_2023_1_OR_NEWER
            RaycastSelector inputSystem = (RaycastSelector)FindAnyObjectByType(typeof(RaycastSelector), FindObjectsInactive.Include);
#else
        ...
        private static void CreateProgressBar(MenuCommand menuCommand)
        {
            ...
            {
                GameObject progressBarGraphic = Instantiate(slider.progressBarPrefab, go.transform, true);
