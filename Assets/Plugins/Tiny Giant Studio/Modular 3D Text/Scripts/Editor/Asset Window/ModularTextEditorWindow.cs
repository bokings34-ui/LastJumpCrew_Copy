...
namespace TinyGiantStudio.Text.EditorFiles
{
    public class ModularTextEditorWindow : EditorWindow
    {
        ...
        const string DocumentationLink = "https://ferdowsur.gitbook.io/modular-3d-text/";
        const string ForumLink = "https://forum.unity.com/threads/modular-3d-text-complete-ingame-ui-sytem.821931/";

        #endregion Links

        #region Tabs

        readonly string _selectedTabClassName = "tabSelected";

        GroupBox _tabsHolder;
        UnityEngine.UIElements.Button _informationTabButton;
        UnityEngine.UIElements.Button _settingsTabButton;
        UnityEngine.UIElements.Button _createFontTabButton;
        UnityEngine.UIElements.Button _utilityTabButton;

        #endregion Tabs

        #region Theme

        EditorThemeManager _themeManager;
        ...
        GroupBox rootHolder;
        UnityEngine.UIElements.Button darkModeButton;
        UnityEngine.UIElements.Button lightModeButton;
        VisualElement themeModeBackgroundButton;
        ...
        GroupBox createFontContent;
        UnityEngine.UIElements.Button createFontButton;
        Foldout previewFoldout;
        ScrollView previewScrollview;

        CharacterGenerator _characterGenerator;
        ...
        readonly string kerningDocumentationDocURL = "https://ferdowsur.gitbook.io/modular-3d-text/text/fonts/creating-fonts/troubleshoot#no-kerning-found";
        readonly string fontCreationTroubleShootDocURL = "https://ferdowsur.gitbook.io/modular-3d-text/fonts/creating-fonts/troubleshoot";

        #endregion Font creation variables

        MaterialPreviewManager _materialPreviewManager;

        MaterialPreviewManager materialPreviewManager
        {
            get
            {
        ...
        void SetupTabs()
        {
            _tabsHolder = rootVisualElement.Q<GroupBox>("Tabs");

            _informationTabButton = _tabsHolder.Q<UnityEngine.UIElements.Button>("InformationTabButton");
            _settingsTabButton = _tabsHolder.Q<UnityEngine.UIElements.Button>("SettingsTabButton");
            _createFontTabButton = _tabsHolder.Q<UnityEngine.UIElements.Button>("CreateFontTabButton");
            _utilityTabButton = _tabsHolder.Q<UnityEngine.UIElements.Button>("UtilityTabButton");

            _informationTabButton.clicked += () =>
            {
                OpenInformationTab();
            };
            _settingsTabButton.clicked += () =>
            {
                OpenSettingsTab();
            };
            _createFontTabButton.clicked += () =>
            {
                OpenCreateFontTab();
            };
            _utilityTabButton.clicked += () =>
            {
                OpenUtilityTab();
            };
        }
        ...
        {
            _informationTabButton.AddToClassList(_selectedTabClassName);
            _settingsTabButton.RemoveFromClassList(_selectedTabClassName);
            _createFontTabButton.RemoveFromClassList(_selectedTabClassName);
            _utilityTabButton.RemoveFromClassList(_selectedTabClassName);
        ...
        void OpenCreateFontTab()
        {
            _createFontTabButton.AddToClassList(_selectedTabClassName);
            _settingsTabButton.RemoveFromClassList(_selectedTabClassName);
            _informationTabButton.RemoveFromClassList(_selectedTabClassName);
            _utilityTabButton.RemoveFromClassList(_selectedTabClassName);
        ...
        {
            _settingsTabButton.AddToClassList(_selectedTabClassName);
            _informationTabButton.RemoveFromClassList(_selectedTabClassName);
            _utilityTabButton.RemoveFromClassList(_selectedTabClassName);
            _createFontTabButton.RemoveFromClassList(_selectedTabClassName);
        ...
        void OpenUtilityTab()
        {
            _utilityTabButton.AddToClassList(_selectedTabClassName);
            _informationTabButton.RemoveFromClassList(_selectedTabClassName);
            _settingsTabButton.RemoveFromClassList(_selectedTabClassName);
            _createFontTabButton.RemoveFromClassList(_selectedTabClassName);
        ...
        void SetupInformationTab()
        {
            ...
            informationHolder.Q<UnityEngine.UIElements.Button>("CopyEmailButton").clicked += () =>
            {
                ...
                ShowNotification(new GUIContent("Email copied"), 1);
            };
        }
        ...
        void SetupTextDefaultSettings(GroupBox settingsContent)
        {
        ...
        void SetupButtonDefaultSettings(GroupBox settingsContent)
        {
        ...
        void SetupButtonNormalStyle(Foldout foldout)
        {
        ...
        void SetupButtonSelectedStyle(Foldout foldout)
        {
        ...
        void SetupButtonPressedStyle(Foldout foldout)
        {
        ...
        void SetupButtonDisabledStyle(Foldout foldout)
        {
        ...
        void SetupListDefaultSettings(GroupBox settingsContent)
        {
        ...
        void SetupListNormalStyle(Foldout foldout)
        {
            GroupBox groupBox = foldout.Q<GroupBox>("NormalStyleGroupBox");
        ...
        void SetupListSelectedStyle(Foldout foldout)
        {
            GroupBox groupBox = foldout.Q<GroupBox>("SelectedStyleGroupBox");
        ...
        void SetupListPressedStyle(Foldout foldout)
        {
            GroupBox groupBox = foldout.Q<GroupBox>("PressedStyleGroupBox");
        ...
        void SetupListDisabledStyle(Foldout foldout)
        {
            GroupBox groupBox = foldout.Q<GroupBox>("DisabledStyleGroupBox");
        ...
        /// </summary>
        void SetupDefaultSettingForCommonStylePattern
            (
            GroupBox groupBox,
        ...
        void SetupInputSetting(GroupBox settingsContent)
        {
        ...
        void ApplyDefaultFontToScene()
        {
            ...
            {
#if UNITY_2023_1_OR_NEWER
                foreach (var text in FindObjectsByType<Modular3DText>())
#else
        ...
        void ApplyDefaultListNormalTextSizeToScene()
        {
            ...
            {
#if UNITY_2023_1_OR_NEWER
                foreach (var list in FindObjectsByType<List>())
#else
        ...
        void ApplyDefaultListDisabledTextMaterialToScene()
        {
            ...
            if (EditorUtility.DisplayDialog("Confirmation", notice, "Apply", "Do not apply"))
            {
                foreach (List list in FindObjectsByType<List>())
                {
        ...
        void CleanUpPreview(Preview preview)
        {
            preview.meshPreview?.Dispose();
        ...
        void UpdatePrebuiltCharacterFields()
        {
        ...
        void SetupAssemblyDefinitionFile()
        {
        ...
        void SetupURLButton(GroupBox holder, string buttonName, string targetURL)
        {
