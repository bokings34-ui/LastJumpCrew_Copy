...
namespace TinyGiantStudio.Text
{
    ...
    public class FontEditor : Editor
    {
        ...
        SerializedProperty spaceSpacing; //to-do: rename to word spacing?
        ...
        static Color unimportedLabelColor = new Color(239 / 255f, 239 / 255f, 239 / 255f, 0.9f);

        AnimBool showSettings;
        AnimBool showFallBackSettingsInEditor;
        AnimBool showSpacingSettingsInEditor;
        AnimBool showBaseSettingsInEditor;
        AnimBool showKerningTableInEditor;
        AnimBool showCharacterListInEditor;
