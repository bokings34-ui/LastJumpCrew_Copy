...
namespace TinyGiantStudio.Text.EditorFiles
{
    ...
    public class EditorThemeManager
    {
        ...
        readonly string normalButtonClassName = "normalButton";
        readonly string iconButtonClassName = "iconButton";
        readonly string textButtonClassName = "textButton";

        #endregion XML classNames

        readonly string themeEditorPrefName = "TGSInspectorDarkTheme";
        public Theme _theme;
        ...
        VisualElement iconBackground;
        VisualElement lightModeBG;
        VisualElement darkModeBG;
        ...
        void ChangeAllFieldBackgroundColor()
        {
        ...
        void UpdateThemeSwitcherButtons()
        {
            if (Theme == Theme.Light)
            {
