...
namespace TinyGiantStudio.Text
{
    ...
    public class Modular3DTextEditor : Editor
    {
        ...
        SerializedProperty autoFontSize;
        SerializedProperty minFontSize;
        SerializedProperty maxFontSize;

        SerializedProperty _wordSpacing;
        SerializedProperty autoLetterSize;
        SerializedProperty sizeGraceAmount;
        SerializedProperty fontSizeIterationAmount;
        SerializedProperty maxIterationTimes;
        ...
        SerializedProperty runTimeLogging;
        SerializedProperty editorTimeLogging;
        SerializedProperty logTextUpdates;
        SerializedProperty logFontUpdates;
        SerializedProperty logMaterialUpdates;
        SerializedProperty logDeletedCharacters;
        SerializedProperty logSingleMeshStatus;
        ...
        SerializedProperty secondaryUV_hardAngle;
        SerializedProperty secondaryUV_angleError;
        SerializedProperty secondaryUV_areaError;
        SerializedProperty secondaryUV_packMargin;

        //Debug -- starts
        SerializedProperty wordArray;

        SerializedProperty characterObjectList;
        ...
        static readonly Color openedFoldoutTitleColorLightSkin = new Color(31 / 255f, 31 / 255f, 31 / 255f, 1);
        ...
        bool ShouldShowPrefabSettings() => PrefabUtility.IsPartOfPrefabInstance(myTarget.gameObject) || UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null;
