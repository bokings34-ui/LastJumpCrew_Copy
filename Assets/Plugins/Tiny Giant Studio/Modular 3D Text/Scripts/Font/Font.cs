...
namespace TinyGiantStudio.Text
{
    ...
    public class Font : ScriptableObject
    {
        ...
        private void ProcessName(string targetName, out char character, out float spacing)
        {
            try
            {
                NewMethod(targetName, out character, out spacing);
            }
            catch
            {
                //Debug.Log("Old method");
                OldMethod(targetName, out character, out spacing);
            }
        }
