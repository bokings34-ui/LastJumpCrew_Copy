...
namespace TinyGiantStudio.EditorHelpers
{
    ...
    {
        static readonly float defaultTinyHorizontalFieldSize = 50f;
        static readonly float defaultSmallHorizontalFieldSize = 72.5f;
        static readonly float defaultNormalltHorizontalFieldSize = 100;
        static readonly float defaultLargeHorizontalFieldSize = 120f;
        static readonly float defaultExtraLargeHorizontalFieldSize = 155f;
        static readonly float defaultGiganticHorizontalFieldSize = 220;
        static readonly float defaultMegaHorizontalFieldSize = 300;
        ...
        static float GetMyMaxWidth(FieldSize fieldSize)
        {
        ...
        delegate bool DelegateExecuteMenuItemWithTemporaryContext(string menuItemPath, UnityEngine.Object[] objects);

        static DelegateExecuteMenuItemWithTemporaryContext ExecuteMenuItemWithTemporaryContext;
