...
Shader "LastJumpCrew/UI Audit/LedText TMP"
{
    Properties
    {
        ...
        _LedsScale("LedsScale", Range( 0 , 1)) = 0.7
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float4 tex2DNode2 = tex2D( _MainTex, ( round( temp_output_14_0 ) / _LedsAmount ) );
                float smoothstepResult38 = smoothstep( temp_output_29_0 , ( temp_output_29_0 + _TextDilateSmoothness ) , tex2DNode2.a);
                float2 temp_cast_1 = (( ( 0.5 / _LedsScale ) * ( 1.0 - _LedsScale ) )).xx;
                float4 appendResult6 = (float4(( IN.color * pow( 2.0 , _Colorhdr ) ).rgb , ( smoothstepResult38 * tex2D( _LedMaks, ( ( frac( ( ( texCoord4 * _LedsAmount ) + float2( 0.5,0.5 ) ) ) / _LedsScale ) - temp_cast_1 ) ).r )));
