...
namespace LastJumpCrew.ParkHanSol.Multiplayer
{
    public sealed class ParkHanSolGameSettingsController : MonoBehaviour
    {
        ...
        private const float MasterHeadroomDecibels = -3f;
        private const float UiHeadroomDecibels = -2f;
        private const float EffectsHeadroomDecibels = -2f;
        private const float EnvironmentHeadroomDecibels = -4f;
        ...
        private static float ResolveMixerHeadroomDecibels(string parameterName)
        {
            return parameterName switch
            {
                MasterMixerParameter => MasterHeadroomDecibels,
                UiMixerParameter => UiHeadroomDecibels,
                EffectsMixerParameter => EffectsHeadroomDecibels,
                EnvironmentMixerParameter => EnvironmentHeadroomDecibels,
                _ => 0f
            };
        }
